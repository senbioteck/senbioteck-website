import { PrismaClient, UserRole, SlotStatus, AppointmentStatus, PageStatus, BlogPostStatus, ResourceCategory } from '@prisma/client';
...
async function main() {
  ...
  await prisma.healthResource.create({
    data: {
      ...
      category: ResourceCategory.PREVENTION,
      isFeatured: true,
      publishedAt: new Date(),
    },
  });
